...
Teleport()
    ...
    if World3 then
       ...
       local BoneSection = MainTab:CreateSection({
            Name = "Bone",
            Side = "Left"
        })

        local Total_Bone = BoneSection:AddLabel({
            Name = "Total",
            Flag = "Total"
        })
...
spawn(function()
        pcall(function()
            while wait() do
               Total_Bone:Set("Bone : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
            end
        end)
    end)
    ...
    local RaceTab = PepsisWorld:CreateTab({
        Name = "Race V4"
    })
    
    local RaceCompleSection = RaceTab:CreateSection({
        Name = "Race Comple Trial",
        Side = "Left"
    })

    RaceCompleSection:AddToggle{
        Name = "Auto Comple Trial All Race",
        Flag = "Auto_Quest_Race",
        Value = _G.Settings.AutoQuestRace,
        Callback  = function(value)
            _G.AutoQuestRace = value
            _G.Settings.AutoQuestRace = value
            saveSettings()
        end
    }
   ...
   spawn(function()
				...
				elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Skypiea" then
					for i,v in pairs(game:GetService("Workspace").Map.SkyTrial.Model:GetDescendants()) do
						if v.Name ==  "snowisland_Cylinder.081" then
							getgenv().ToTarget(v.CFrame* CFrame.new(0,0,0))
						end
					end
				...
				elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Mink" then
					for i,v in pairs(game:GetService("Workspace"):GetDescendants()) do
						if v.Name == "StartPoint" then
							getgenv().ToTarget(v.CFrame* CFrame.new(0,10,0))
					  	end
				   	end
				end
			end
    ...
    RaceCompleSection:AddToggle{
        ...
        Flag = "AutoQuestRace",
        Value = _G.Settings.Teleracedoor,
        Callback  = function(value)
            _G.Teleracedoor = value
            _G.Settings.Teleracedoor = value
            saveSettings()
        end
    }
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.Teleracedoor then
				if game:GetService("Players").LocalPlayer.Data.Race.Value == "Human" then
getgenv().ToTarget(CFrame.new(29221.822265625, 14890.9755859375, -205.99114990234375))
				elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Skypiea" then
getgenv().ToTarget(CFrame.new(28960.158203125, 14919.6240234375, 235.03948974609375))
				elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Fishman" then
getgenv().ToTarget(CFrame.new(28231.17578125, 14890.9755859375, -211.64173889160156))
				elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Cyborg" then
getgenv().ToTarget(CFrame.new(28502.681640625, 14895.9755859375, -423.7279357910156))
				elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Ghoul" then
getgenv().ToTarget(CFrame.new(28674.244140625, 14890.6767578125, 445.4310607910156))
				elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Mink" then
getgenv().ToTarget(CFrame.new(29012.341796875, 14890.9755859375, -380.1492614746094))
					  	end
				   	end
				end
        end)
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14896.8505859375, 102.62469482421875)
    ...
    local MirageCompleSection = RaceTab:CreateSection({
        Name = "Mirage",
        Side = "Left"
    })

    MirageCompleSection:AddToggle{
        Name = "Teleport To Mirage",
        Flag = "Tween_MRIG",
        Value = _G.Settings.TweenMRIG,
        Callback  = function(value)
            _G.TweenMRIG = value
            _G.Settings.TweenMRIG = value
            saveSettings()
        end
    }
...
spawn(function()
        ...
        while wait() do
            if _G.TweenMRIG then
				if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
					...
					getgenv().ToTarget(CFrame.new(_G.CenterMI))
				end
			end
        end
    end)
    ...
    MirageCompleSection:AddToggle{
        ...
        Flag = "Tween_M_Gear",
        Value = _G.Settings.TweenMGear,
        Callback  = function(value)
            _G.TweenMGear = value
            _G.Settings.TweenMGear = value
            saveSettings()
        end
    }
...
spawn(function()
    ...
    local MirageSTCompleSection = RaceTab:CreateSection({
        Name = "Status",
        Side = "Right"
    })

local mr = MirageSTCompleSection:AddLabel({
...
local FullMoon = MirageSTCompleSection:AddLabel({
    ...
    local EspML = CombatTab:CreateSection({
        Name = "Esp",
        Side = "Right"
    })
...
_G.Sele_Teleport_Fruit = "Tween"

    DevilFruitShopSection:AddToggle({
        Name = "Teleport To Fruit",
        Flag = "Auto_Teleport_Fruit",
        Value = _G.Settings.Auto_Teleport_Fruit,
        Callback = function(value)
            _G.Auto_Teleport_Fruit = value    
            _G.Settings.Auto_Teleport_Fruit = value
            saveSettings()
        end
    })
--Sele_Teleport_Fruit
task.spawn(function()
	while wait() do
		if _G.Auto_Teleport_Fruit then
			pcall(function()
				for i,v in pairs(game.Workspace:GetChildren()) do
					if v:IsA("Tool") and v:FindFirstChild('Handle') then
						if _G.Sele_Teleport_Fruit == "Bring" and _G.Auto_Teleport_Fruit then 
							firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,v.Handle,0)  
							firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,v.Handle,1)  
						end
						if _G.Sele_Teleport_Fruit == "Tween" and _G.Settings.Devil_Fruit["Bring Fruit"] then 
							_G.BringFound = true 
							getgenv().ToTarget(v.Handle.CFrame)
						end
					end
					if v.Name == "Fruit " and v:FindFirstChild("Handle") then
						...
						if _G.Sele_Teleport_Fruit == "Tween" and _G.Auto_Teleport_Fruit then 
							getgenv().ToTarget(v.Handle.CFrame)
						end
					end
				end	
